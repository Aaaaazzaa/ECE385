...
module lab7_soc_mm_interconnect_0 (
	...
	wire   [25:0] aes_aes_slave_agent_m0_address;                                                     // AES_AES_Slave_agent:m0_address -> AES_AES_Slave_translator:uav_address
	...
	wire  [102:0] aes_aes_slave_agent_rf_source_data;                                                 // AES_AES_Slave_agent:rf_source_data -> AES_AES_Slave_agent_rsp_fifo:in_data
	...
	wire  [102:0] aes_aes_slave_agent_rsp_fifo_out_data;                                              // AES_AES_Slave_agent_rsp_fifo:out_data -> AES_AES_Slave_agent:rf_sink_data
	...
	wire  [101:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> AES_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // AES_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [6:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> AES_AES_Slave_agent:cp_channel
	...
	wire    [6:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire  [101:0] aes_aes_slave_agent_rp_data;                                                        // AES_AES_Slave_agent:rp_data -> router_002:sink_data
	...
	wire    [6:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> cmd_mux_005:sink1_channel
	...
	wire    [6:0] rsp_demux_005_src1_channel;                                                         // rsp_demux_005:src1_channel -> rsp_mux_001:sink3_channel
	...
	wire    [6:0] crosser_001_out_channel;                                                            // crosser_001:out_channel -> cmd_mux_006:sink1_channel
	...
	wire    [6:0] rsp_demux_006_src0_channel;                                                         // rsp_demux_006:src0_channel -> crosser_002:in_channel
	...
	wire    [6:0] crosser_002_out_channel;                                                            // crosser_002:out_channel -> rsp_mux:sink6_channel
	...
	wire    [6:0] rsp_demux_006_src1_channel;                                                         // rsp_demux_006:src1_channel -> crosser_003:in_channel
	...
	lab7_soc_mm_interconnect_0_router_004 router_007 (
	...
	lab7_soc_mm_interconnect_0_router_008 router_008 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_006 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_006 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
