...
# setting SOPC_SYSID_BASE_ADDRESS is 0xb8
SOPC_SYSID_FLAG += --sidp=0xb8
ELF_PATCH_FLAG  += --sidp 0xb8

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1551652211
SOPC_SYSID_FLAG += --timestamp=1551652211
ELF_PATCH_FLAG  += --timestamp 1551652211
