...
module lab7_soc_mm_interconnect_0 (
	...
	wire    [8:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> sysid_qsys_0_control_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_002_src_channel;                                                            // cmd_mux_002:src_channel -> sdram_pll_pll_slave_agent:cp_channel
	...
	wire    [8:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> SW_s1_agent:cp_channel
	...
	wire   [25:0] key3_s1_agent_m0_address;                                                           // KEY3_s1_agent:m0_address -> KEY3_s1_translator:uav_address
	...
	wire  [104:0] key3_s1_agent_rf_source_data;                                                       // KEY3_s1_agent:rf_source_data -> KEY3_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] key3_s1_agent_rsp_fifo_out_data;                                                    // KEY3_s1_agent_rsp_fifo:out_data -> KEY3_s1_agent:rf_sink_data
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> KEY3_s1_agent:cp_valid
	wire  [103:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> KEY3_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // KEY3_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire    [8:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> KEY3_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> KEY3_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> KEY3_s1_agent:cp_endofpacket
	...
	wire   [25:0] key2_s1_agent_m0_address;                                                           // KEY2_s1_agent:m0_address -> KEY2_s1_translator:uav_address
	...
	wire  [104:0] key2_s1_agent_rf_source_data;                                                       // KEY2_s1_agent:rf_source_data -> KEY2_s1_agent_rsp_fifo:in_data
	...
	wire  [104:0] key2_s1_agent_rsp_fifo_out_data;                                                    // KEY2_s1_agent_rsp_fifo:out_data -> KEY2_s1_agent:rf_sink_data
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> KEY2_s1_agent:cp_valid
	wire  [103:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> KEY2_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // KEY2_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> KEY2_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> KEY2_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> KEY2_s1_agent:cp_endofpacket
	...
	wire          key3_s1_agent_rp_valid;                                                             // KEY3_s1_agent:rp_valid -> router_009:sink_valid
	wire  [103:0] key3_s1_agent_rp_data;                                                              // KEY3_s1_agent:rp_data -> router_009:sink_data
	wire          key3_s1_agent_rp_ready;                                                             // router_009:sink_ready -> KEY3_s1_agent:rp_ready
	wire          key3_s1_agent_rp_startofpacket;                                                     // KEY3_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          key3_s1_agent_rp_endofpacket;                                                       // KEY3_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          key2_s1_agent_rp_valid;                                                             // KEY2_s1_agent:rp_valid -> router_010:sink_valid
	wire  [103:0] key2_s1_agent_rp_data;                                                              // KEY2_s1_agent:rp_data -> router_010:sink_data
	wire          key2_s1_agent_rp_ready;                                                             // router_010:sink_ready -> KEY2_s1_agent:rp_ready
	wire          key2_s1_agent_rp_startofpacket;                                                     // KEY2_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          key2_s1_agent_rp_endofpacket;                                                       // KEY2_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire  [103:0] cmd_demux_001_src8_data;                                                            // cmd_demux_001:src8_data -> cmd_mux_008:sink1_data
	...
	wire  [103:0] rsp_demux_008_src1_data;                                                            // rsp_demux_008:src1_data -> rsp_mux_001:sink8_data
	...
	wire    [8:0] router_007_src_channel;                                                             // router_007:src_channel -> sdram_s1_rsp_width_adapter:in_channel
	...
	wire    [8:0] sdram_s1_rsp_width_adapter_src_channel;                                             // sdram_s1_rsp_width_adapter:out_channel -> rsp_demux_005:sink_channel
	...
	wire    [8:0] cmd_mux_005_src_channel;                                                            // cmd_mux_005:src_channel -> sdram_s1_cmd_width_adapter:in_channel
	...
	wire          key3_s1_agent_rdata_fifo_src_valid;                                                 // KEY3_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] key3_s1_agent_rdata_fifo_src_data;                                                  // KEY3_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          key3_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_007:in_0_ready -> KEY3_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> KEY3_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> KEY3_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // KEY3_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> KEY3_s1_agent:rdata_fifo_sink_error
	wire          key2_s1_agent_rdata_fifo_src_valid;                                                 // KEY2_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] key2_s1_agent_rdata_fifo_src_data;                                                  // KEY2_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          key2_s1_agent_rdata_fifo_src_ready;                                                 // avalon_st_adapter_008:in_0_ready -> KEY2_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> KEY2_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> KEY2_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // KEY2_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> KEY2_s1_agent:rdata_fifo_sink_error
