...
module lab7_soc_mm_interconnect_0 (
	...
	wire  [103:0] cmd_mux_010_src_data;                                                               // cmd_mux_010:src_data -> otg_hpi_w_s1_agent:cp_data
	...
	wire  [103:0] cmd_mux_011_src_data;                                                               // cmd_mux_011:src_data -> otg_hpi_cs_s1_agent:cp_data
	wire          cmd_mux_011_src_ready;                                                              // otg_hpi_cs_s1_agent:cp_ready -> cmd_mux_011:src_ready
	wire   [12:0] cmd_mux_011_src_channel;                                                            // cmd_mux_011:src_channel -> otg_hpi_cs_s1_agent:cp_channel
	...
	wire  [103:0] cmd_mux_012_src_data;                                                               // cmd_mux_012:src_data -> otg_hpi_reset_s1_agent:cp_data
	...
	wire  [103:0] otg_hpi_w_s1_agent_rp_data;                                                         // otg_hpi_w_s1_agent:rp_data -> router_012:sink_data
	...
	wire  [103:0] otg_hpi_cs_s1_agent_rp_data;                                                        // otg_hpi_cs_s1_agent:rp_data -> router_013:sink_data
	...
	wire  [103:0] otg_hpi_reset_s1_agent_rp_data;                                                     // otg_hpi_reset_s1_agent:rp_data -> router_014:sink_data
	...
	wire  [103:0] cmd_demux_001_src3_data;                                                            // cmd_demux_001:src3_data -> crosser_001:in_data
	wire          cmd_demux_001_src3_ready;                                                           // crosser_001:in_ready -> cmd_demux_001:src3_ready
	wire   [12:0] cmd_demux_001_src3_channel;                                                         // cmd_demux_001:src3_channel -> crosser_001:in_channel
	...
	wire  [103:0] crosser_003_out_data;                                                               // crosser_003:out_data -> rsp_mux_001:sink3_data
	wire          crosser_003_out_ready;                                                              // rsp_mux_001:sink3_ready -> crosser_003:out_ready
	wire   [12:0] crosser_003_out_channel;                                                            // crosser_003:out_channel -> rsp_mux_001:sink3_channel
	...
	lab7_soc_mm_interconnect_0_router_004 router_004 (
	...
	lab7_soc_mm_interconnect_0_router_004 router_005 (
	...
	lab7_soc_mm_interconnect_0_router_004 router_006 (
	...
	lab7_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_002 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_003 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_004 (
		.clk                 (clk_0_clk_clk),                                  //       clk.clk
		.reset               (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_cmd_mux_002 cmd_mux_005 (
		.clk                 (sdram_pll_c0_clk),                        //       clk.clk
		.reset               (sdram_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_002 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_003 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_004 (
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	lab7_soc_mm_interconnect_0_rsp_demux_002 rsp_demux_005 (
		.clk                (sdram_pll_c0_clk),                             //       clk.clk
		.reset              (sdram_reset_reset_bridge_in_reset_reset),      // clk_reset.reset
